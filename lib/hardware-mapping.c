...
struct HardwareMapping matrix_hardware_mappings[] = {
   ...
   */
  {
    ...
    .p0_r1         = GPIO_BIT(2),  /* masks: SPI0_SCKL  */
    .p0_g1         = GPIO_BIT(3),  /* Not on RPi1, Rev1; use "regular-pi1" instead */
    .p0_b1         = GPIO_BIT(6),   /* masks: SPI0_CE1   */
    .p0_r2         = GPIO_BIT(7),   /* masks: SPI0_CE0   */
    .p0_g2         = GPIO_BIT(8),   /* masks: SPI0_MISO  */
    .p0_b2         = GPIO_BIT(9),  /* masks: SPI0_MOSI  */
  },
